    ...
    return (
        <Grid container style={{padding: "78px 104px", textAlign: "center", display: "grid", placeContent: "center"}}>
            <Grid item xs={12} style={{
                ...
                <Typography style={{font: 'normal normal 600 20px/24px Inter', padding: '3px 0',width:'172px',height:'28px'}}>
                DRISHTI
                </Typography>
                <Typography style={{font: 'normal normal normal 16px/20px Inter', padding: '3px 0', color: '#717171',width:'148px', height:'14px'}}>
